...
class ProviderForm(FlaskForm):
    trading_name     = StringField('Nome Fantasia', validators=[DataRequired()], render_kw={'placeholder': 'Nome Fantasia do Fornecedor'})
    company_name     = StringField('Razão Social',  validators=[DataRequired()], render_kw={'placeholder': 'Razão Social do Fornecedor'})
